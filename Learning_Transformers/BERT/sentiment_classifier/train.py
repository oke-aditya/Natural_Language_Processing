...
def run():
    ...
    train_dataset = dataset.BERTDataset(df_train["review"].values, df_train["sentiment"].values)
    ...
    valid_dataset = dataset.BERTDataset(df_valid["review"].values, df_train["sentiment"].values)
